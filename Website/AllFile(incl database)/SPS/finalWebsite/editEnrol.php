...
<DIV id="pagebodydivfull">
	<div id="alignLeft">
	<h4>Enter new CRN to add new Subject or delete the subject by select check box and click on Delete button</h4>
...
<?php
	...
	//select the Result from database
	$query="Select * from tblStudyPlan where `studyPlan`='".$_SESSION['studyPlan']."'" ;
