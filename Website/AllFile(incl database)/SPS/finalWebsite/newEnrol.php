      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">Enroll for New Semester</a></li>
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="timetable(tbl)">Table View</a></li>
          </ul>
        </li>
		<li class="dropdown">
...
<?php
	$query="Select * from tblqualtafecodesica";
...
?>
  ...
  <select class="form-control" id="sel1" name="semester">
    <option>2017 Semester 1</option>
    <option>2017 Semester 2</option>
  </select>
</div>
	
	<form class="navbar-form navbar-left">
      <input type="submit" value="Enroll" class="btn btn-default" formaction="./phpSystem/registerNew.php"/>
	<br/>
</form>
<br/>
<?php
if (isset($_SESSION['registerNew'])){
	...
	//take course list from SESSION
	$crnList = $_SESSION['crnList'];
	
	//select the Result from database
	$query="Select * from tblStudyPlan where `studyPlan`='".$_SESSION['registerNew']."'" ;
